    ...
    PROCESS {
        ...
        foreach ($i in $Name) {
            ...
            if (-not($Password)) {
                ...
                $PasswordIs = ConvertTo-SecureString -AsPlainText $RandomPassword -Force
            ...
            elseif ($Password) {
                ...
                $PasswordIs = ConvertTo-SecureString -AsPlainText $Password -Force
