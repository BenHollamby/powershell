<#
he Chairman has decided that it is in the best interests of his Iron Scripters
...
To that end, he has commissioned a series of PowerShell challenges.
 ...
 Although, you are encouraged to try your hand at all posted challenges.
  Some solutions may require complex coding, perhaps a PowerShell function.
  Others might be no more than a line or two of PowerShell that you would
   type interactively in the console. 
  You are encouraged to share your work in social media, blogs, or 
  sites like GitHub. You are welcome to post links to your work in 
  comments to each challenge. Shall we begin?
...
Your goal is to find the values in $List that do not match anything in $Target.
 ...
 This exercise is classified with an Intermediate level.
